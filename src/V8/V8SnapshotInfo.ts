...
export class V8SnapshotInfo {
  ...
  public firstDominatedNodeIndex: Uint32Array = new Uint32Array();

  public dominatedNodes: Uint32Array = new Uint32Array();
  ...
  private buildDominatedNodes = () => {
    ...
    const rootNodeOrdinal = this.node_list.findIndex((node) => node.id === this.root_id);
